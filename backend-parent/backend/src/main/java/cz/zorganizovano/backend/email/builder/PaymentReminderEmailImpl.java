...
@Service
public class PaymentReminderEmailImpl implements PaymentReminderEmail {
    
    private static final String TEMPLATE_FILE = "/mail-templates/payment-reminder.vm";
