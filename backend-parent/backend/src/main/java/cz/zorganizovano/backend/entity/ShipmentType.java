...
public enum ShipmentType {
    ...
    ZASILKOVNA("Zásilkovna", 99, new ShipmentCountry[] { ShipmentCountry.CESKA_REPUBLIKA }),
    CESKA_POSTA("Česká pošta", 129, new ShipmentCountry[] { ShipmentCountry.CESKA_REPUBLIKA }),
