...
public abstract class OrderCreatedEmailBuilderAbs {
    ...
    public String buildPaymentDetails(PaymentInfo paymentInfo) {
        ...
        sb.append("<table cellpadding=\"10\" cellspacing=\"0\" style=\"border : 2px solid #999; border-collapse: collapse; font-size: 10pt;\">")
                ...
                .append("</tr>")
                .append("<tr>")
                    .append("<th colspan=\"2\" style=\"text-align: left; border : 1px solid #999;\">Pro <strong>ZAHRANIČNÍ platbu v CZK</strong> použijte následující údaje:</th>")
                .append("</tr>")
                .append("<tr>")
                ...
                .append("</tr>")
                .append("<tr>")
                    .append("<th colspan=\"2\" style=\"text-align: left; border : 1px solid #999;\">Pro <strong>ZAHRANIČNÍ platbu v EUR s přepočtem na dnešní kurz ČNB</strong> použijte následující údaje:</th>")
                .append("</tr>")
                .append("<tr>")
                    .append("<th style=\"text-align: left; border : 1px solid #999;\">IBAN:</th>")
                    .append("<td style=\"text-align: right; border-bottom : 1px solid #999;\" nowrap=\"nowrap\">")
                        .append("CZ29 2010 0000 0028 0217 8635")
                    .append("</td>")
                .append("</tr>")
                .append("<tr>")
                    .append("<th style=\"text-align: left; border : 1px solid #999;\">BIC:</th>")
