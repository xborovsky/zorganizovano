...
@Service
public class InvoiceCreatedEmailImpl implements InvoiceCreatedEmail {
    
    private static final String TEMPLATE_FILE = "/mail-templates/invoice-created.vm";
