insert into zorganizovano.items (name, subname, description, price, dimensions, shipping_dimensions, weight_grams)
...
</ul>', 299, '297 x 514 x 10 mm', '297x 310 x 10 mm', 120);
