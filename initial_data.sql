...
values ('KALENDÁŘ 2020 - LIŠČÍ ROK', 'Kalendář na lednici s magnetickou lištou', 'Mějte plány celé své rodiny vždy na očích, na nejfrekventovanějším místě v domácnosti - lednici.
...
values (1, 10, true, 'https://zorganizovano.cz/img-server/img/products/p_1.jpg');
...
<img class="blog-post-img" src="https://zorganizovano.cz:8082/img-api/img/blog/b_2.jpg/{screenWidth};widthPct={widthPct};dpr={dpr}" alt="Jak si zorganizovat čas? 1/3" />
<img class="blog-post-img" src="https://zorganizovano.cz:8082/img-api/img/blog/b_3.jpg/{screenWidth};widthPct={widthPct};dpr={dpr}" alt="Jak si zorganizovat čas? 1/3" />
</div>
...
<div class="blog-post-img-block">
<img class="blog-post-img" src="https://zorganizovano.cz:8082/img-api/img/blog/b_4.jpg/{screenWidth};widthPct={widthPct};dpr={dpr}" alt="Jak si zorganizovat čas? 1/3" />
<img class="blog-post-img" src="https://zorganizovano.cz:8082/img-api/img/blog/b_5.jpg/{screenWidth};widthPct={widthPct};dpr={dpr}" alt="Jak si zorganizovat čas? 1/3" />
<img class="blog-post-img" src="https://zorganizovano.cz:8082/img-api/img/blog/b_1.jpg/{screenWidth};widthPct={widthPct};dpr={dpr}" alt="Jak si zorganizovat čas? 1/3" />
</div>
...
'blog/b_1.jpg',
'/eshop/products/1',
'<img src="https://zorganizovano.cz:8082/img-api/img/blog/b_6.jpg/{screenWidth};widthPct={widthPct};dpr={dpr}"  alt="U nás v eshopu" />');
