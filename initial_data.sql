...
<img class="blog-post-img" src="http://localhost:8082/img-api/img/blog/b_2.jpg/{screenWidth};widthPct={widthPct};dpr={dpr}" alt="Jak si zorganizovat čas? 1/3" />
<img class="blog-post-img" src="http://localhost:8082/img-api/img/blog/b_3.jpg/{screenWidth};widthPct={widthPct};dpr={dpr}" alt="Jak si zorganizovat čas? 1/3" />
</div>
...
<div class="blog-post-img-block">
<img class="blog-post-img" src="http://localhost:8082/img-api/img/blog/b_4.jpg/{screenWidth};widthPct={widthPct};dpr={dpr}" alt="Jak si zorganizovat čas? 1/3" />
<img class="blog-post-img" src="http://localhost:8082/img-api/img/blog/b_5.jpg/{screenWidth};widthPct={widthPct};dpr={dpr}" alt="Jak si zorganizovat čas? 1/3" />
<img class="blog-post-img" src="http://localhost:8082/img-api/img/blog/b_1.jpg/{screenWidth};widthPct={widthPct};dpr={dpr}" alt="Jak si zorganizovat čas? 1/3" />
</div>
...
'blog/b_1.jpg',
'/eshop/products/1',
'<img src="http://localhost:8082/img-api/img/blog/b_6.jpg/{screenWidth};widthPct={widthPct};dpr={dpr}"  alt="U nás v eshopu" />');
