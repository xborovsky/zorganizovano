...
import { ADD_ITEM_TO_SHOPPING_CART } from '~/components/global-context/ShoppingCartActions';
import ShoppingCartButton from '~/components/ShoppingCartButton';
import QuantityInput from '~/components/QuantityInput';
import ProductStockQuantity from '~/components/product/ProductStockQuantity';
...
const ProductListItem = ({ product, onSuccess, classes, width }) => {
    ...
    const goToDetail = () => {
        Router.push(`/public/products/${product.id}`);
    };
